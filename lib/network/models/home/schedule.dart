...
class Schedule {
  ...
  List<ScheduleGroupList> scheduleGroupList;
  ...
  Schedule.fromJson(Map<String, dynamic> json) {
    ...
    if (json['scheduleGroupList'] != null) {
      scheduleGroupList = new List<ScheduleGroupList>();
      json['scheduleGroupList'].forEach((v) {
        scheduleGroupList.add(new ScheduleGroupList.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.scheduleGroupList != null) {
      data['scheduleGroupList'] =
          this.scheduleGroupList.map((v) => v.toJson()).toList();
    }
...
class ScheduleGroupList {
  ...
  ScheduleGroupList.fromJson(Map<String, dynamic> json) {
